  ...
  return (
    <group>
      <mesh position={basePosition} castShadow receiveShadow>
        ...
        <meshStandardMaterial color={PALETTE.blackenedMetal} roughness={0.32} metalness={0.72} />
      </mesh>
      ...
      <mesh position={[basePosition[0], basePosition[1] + 0.08 + postHeight, basePosition[2] + 0.015]} castShadow>
        ...
        <meshStandardMaterial color={PALETTE.blackenedMetal} roughness={0.3} metalness={0.7} />
      </mesh>
      ...
      <group position={keyboardPosition} rotation-y={screenRotationY}>
        <mesh castShadow receiveShadow>
          ...
          <meshStandardMaterial color={PALETTE.blackenedMetal} roughness={0.34} metalness={0.42} />
        </mesh>
        ...
        <mesh position={[0.47, 0.018, 0.015]} castShadow>
          ...
          <meshStandardMaterial color={PALETTE.blackenedMetal} roughness={0.38} metalness={0.28} />
        </mesh>
      ...
      <mesh position={grommetPosition} rotation-x={Math.PI / 2} receiveShadow>
        ...
        <meshStandardMaterial color={PALETTE.blackenedMetal} roughness={0.48} metalness={0.3} />
      </mesh>
      <mesh position={powerBrickPosition} castShadow>
        <boxGeometry args={[0.18, 0.035, 0.07]} />
        <meshStandardMaterial color={PALETTE.blackenedMetal} roughness={0.6} metalness={0.12} />
      </mesh>
      ...
      <group position={screenPosition} rotation={[screenTiltX, screenRotationY, 0]}>
        ...
        <mesh castShadow receiveShadow>
          ...
          <meshStandardMaterial color={PALETTE.blackenedMetal} roughness={0.28} metalness={0.58} />
        </mesh>
        ...
        <mesh position={[0, height * 0.31, depth / 2 + 0.032]} castShadow>
          ...
          <meshStandardMaterial color={PALETTE.blackenedMetal} roughness={0.3} metalness={0.62} />
        </mesh>
...
function buildScreenTexture(accent: string): THREE.CanvasTexture {
  ...
  if (context) {
    ...
    context.globalAlpha = 1;
    context.strokeStyle = PALETTE.evidence;
